...
public class PreferenceConstants {
	...
	public static final String P_DLL = "globalDLL";
	public static final String P_SO = "globalSO";
	public static final String P_LIB = "globalLib";
	public static final String P_PLAT = "globalPlat";
